...
function StepCard({
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col gap-3 sm:gap-4">
      <p className="whitespace-nowrap font-nav-cta text-description font-bold leading-none text-[#d8c648]">
        {number}. {label}
      </p>
      <div
  ...
  return (
    <section className="overflow-x-clip bg-[#cb513c]">
      <SiteContainer className="flex min-w-0 flex-col gap-8 px-4 py-12 sm:gap-10 sm:px-6 sm:py-20 lg:flex-row lg:items-end lg:justify-start">
        <h2 className="whitespace-nowrap font-nav-title text-heading-easy-steps font-bold uppercase leading-[0.9] text-[#fffaee] [-webkit-text-stroke:4px_#e57c62] [paint-order:stroke_fill] lg:vertical-label lg:shrink-0 lg:leading-[0.84]">
          EASY STEPS
        </h2>
